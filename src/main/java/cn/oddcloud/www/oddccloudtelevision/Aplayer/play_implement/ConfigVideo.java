package cn.oddcloud.www.oddccloudtelevision.Aplayer.play_implement;
...
import static cn.oddcloud.www.oddccloudtelevision.Aplayer.play_interface.IConfigVideo.AspectRatioType.RatioNative;
import static cn.oddcloud.www.oddccloudtelevision.Aplayer.play_interface.IConfigVideo.AspectRatioType.RationFullScreen;
...
public class ConfigVideo implements IConfigVideo {
    ...
    public boolean open() {
       ...
       // In SoftWare Decode,must set view full displayArea, aplayer engine will control  display area size
		DisplayAreaSetUtil.adjustFullScreenDisplaySize(mPlayDisplayView);
